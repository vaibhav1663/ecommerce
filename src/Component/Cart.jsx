                        ...
                        <div class="pointer-events-auto w-screen max-w-md">
                            <div class="flex h-full flex-col bg-white shadow-xl">
                                <div class="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
                                    <div class="flex items-start justify-between">
                                        ...
                                        <div class="ml-3 flex h-7 items-center">
                                            <button onClick={()=>{setCart(!cart)}} type="button"  class="relative -m-2 p-2 text-gray-400 hover:text-gray-500">
                                ...
                                <div class="border-t border-gray-200 px-4 py-6 sm:px-6">
                                    ...
                                    <div class="mt-6">
                                        <Link to="/checkout" onClick={()=>{setCart(!cart)}} class="flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700">Checkout</Link>
                                    </div>
